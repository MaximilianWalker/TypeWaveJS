...
<h1 align="center" style="font-size: 100px; display: flex; flex-direction:column;">
  TypeWave JS
  <span style="display: flex; font-size: 40px; vertical-align: middle; color: rgb(88 196 220); gap: 20px; margin: 0 auto; margin-top: 20px">
    <svg 
      width="60px" 
      height="100%" 
